...
export function ConsentBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm border-t border-border p-4 shadow-lg">
      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
        <div className="flex items-center gap-3 text-muted-foreground">
          ...
          <p>
            ...
            <Link href="/politica-de-privacidade" className="underline hover:text-foreground">Saiba mais</Link>.
          </p>
        </div>
