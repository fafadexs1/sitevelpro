                        ...
                        <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                            {streamingServices.map((service) => (
                                <motion.div
                                    ...
                                    className={`relative cursor-pointer rounded-lg border-2 transition-all duration-300 ease-out h-24 sm:h-auto sm:aspect-video ${selectedService.logoAlt === service.logoAlt
                                ...
                                >
                                    <Image
                                        ...
                                        className="object-contain p-2 sm:p-4 bg-black/40 backdrop-blur-md rounded-lg border border-white/10"
                                    />
                                </motion.div>
                            ))}
                        </div>
