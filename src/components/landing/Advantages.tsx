...
const AdvantageCard = ({ item }: { item: { icon: 'shield' | 'gauge' | 'zap' | 'rocket' | 'wifi' | 'phone'; title: string; desc: string; } }) => (
  <div className="group relative rounded-2xl border border-border/50 bg-card/60 backdrop-blur-sm p-6 overflow-hidden transition-all duration-300 hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-1">
