...
const BentoCard = ({ children, className = "", delay = 0 }: { children: React.ReactNode, className?: string, delay?: number }) => (
  <motion.div
    ...
    className={`group relative overflow-hidden rounded-3xl bg-neutral-900/80 border border-white/10 p-6 hover:border-[#03BF03]/30 transition-all duration-300 ${className}`}
  >
    {/* Hover Gradient Bloom */}
    <div className="absolute -inset-px bg-gradient-to-br from-[#03BF03]/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl" />
      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight mb-4">
            Por que a <span className="text-[#03BF03]">Velpro</span> é diferente?
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-4 md:h-[800px]">
          ...
          <BentoCard className="md:col-span-2 md:row-span-2 flex flex-col justify-between bg-gradient-to-br from-[#03BF03]/20 to-neutral-900">
            <div className="mb-4">
              <div className="w-12 h-12 rounded-full bg-[#03BF03]/20 flex items-center justify-center mb-4">
                <Rocket className="w-6 h-6 text-[#03BF03]" />
              </div>
            ...
            {/* Abstract visual */}
            <div className="h-32 w-full rounded-2xl bg-gradient-to-r from-[#03BF03]/10 to-transparent border border-[#03BF03]/20 relative overflow-hidden mt-4 group-hover:scale-[1.02] transition-transform">
              <div className="absolute inset-0 bg-[linear-gradient(90deg,transparent,rgba(3,191,3,0.2),transparent)] animate-[shimmer_2s_infinite]" />
              <div className="absolute top-1/2 left-0 w-full h-0.5 bg-[#03BF03]/30" />
            </div>
          </BentoCard>
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 h-full">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <Wifi className="w-5 h-5 text-[#03BF03]" />
                  <span className="text-sm font-bold text-[#03BF03] uppercase tracking-wider">Novo Padrão</span>
                </div>
              ...
              <div className="w-full md:w-1/3 aspect-square md:aspect-auto h-24 rounded-full bg-[#03BF03]/5 blur-2xl animate-pulse" />
            </div>
          </BentoCard>
          ...
          <BentoCard className="md:col-span-1 md:row-span-2" delay={0.2}>
            <div className="h-full flex flex-col">
              ...
              <div className="mt-auto px-4 py-2 rounded-lg bg-[#03BF03]/10 border border-[#03BF03]/20 text-center">
                <span className="text-[#03BF03] font-bold text-sm">Suporte Especializado</span>
              </div>
            </div>
          </BentoCard>
